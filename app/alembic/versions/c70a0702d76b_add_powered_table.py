...
def upgrade() -> None:
    op.create_table('consumption_daily_max_power',
    ...
    op.create_index(op.f('ix_consumption_daily_max_power_id'), 'consumption_daily_max_power', ['id'], unique=True)
    op.create_index(op.f('ix_consumption_daily_max_power_usage_point_id'), 'consumption_daily_max_power',
...
def downgrade() -> None:
    op.drop_index(op.f('ix_consumption_daily_max_power_usage_point_id'), table_name='consumption_daily_max_power')
    op.drop_index(op.f('ix_consumption_daily_max_power_id'), table_name='consumption_daily_max_power')
