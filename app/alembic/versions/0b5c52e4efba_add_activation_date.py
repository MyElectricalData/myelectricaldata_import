...
def upgrade() -> None:
    ...
    op.add_column('usage_points', sa.Column('consumption_detail_max_date', sa.DateTime(), nullable=True))
    op.add_column('usage_points', sa.Column('production_max_date', sa.DateTime(), nullable=True))
    op.add_column('usage_points', sa.Column('production_detail_max_date', sa.DateTime(), nullable=True))
